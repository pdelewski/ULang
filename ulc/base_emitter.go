...
func (v *BaseEmitter) PreVisitAssignStmtLhs(node []ast.Expr, indent int)                         {}
func (v *BaseEmitter) PostVisitAssignStmtLhs(node []ast.Expr, indent int)                        {}
func (v *BaseEmitter) PreVisitAssignStmtRhs(node []ast.Expr, indent int)                         {}
func (v *BaseEmitter) PostVisitAssignStmtRhs(node []ast.Expr, indent int)                        {}
