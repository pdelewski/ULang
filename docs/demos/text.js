...
function main() {
  ...
  let program = createHelloWorldDemo();
  ...
  graphics.RunLoop(w, function (w) {
    ...
    while (true) {
      ...
      while (true) {
        ...
        let memAddr = TextScreenBase + charY * TextCols + charX;
            ...
            while (true) {
              ...
              while (true) {
                ...
                if (font.GetPixel(fontData, charCode, pixelX, pixelY)) {
                  let screenX = int32(charX * 8 + pixelX) * scale;
                  let screenY = int32(charY * 8 + pixelY) * scale;
                  graphics.FillRect(
                    w,
