...
// 8x8 bitmap font for ASCII characters 32-127
...
// GetCharBitmap returns the 8-byte bitmap for a character
// charCode should be ASCII 32-127
func GetCharBitmap(fontData []uint8, charCode int) []uint8 {
	result := []uint8{}
	code := charCode
	if code < 32 {
		code = 32
